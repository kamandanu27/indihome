                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody style="text-transform: uppercase;">
                                ...
                                where tbl_pelanggan.status = 'Aktif' and tbl_pelanggan.id_kab_kota = '$id_wilayah'");
                                $no = 1;
                                while($pelanggan = mysqli_fetch_array($q_pelanggan)){
                                    echo "<tr class='odd gradeX'>
                                        ...
                                        <td>
                                            <a href='aksi_pelanggan.php?&act=nonaktifkan&id=$pelanggan[id_pelanggan]' class='btn btn-info btn-xs'>
                                            <i class='fa fa-check'></i> Non Aktifkan</a>
                                        </td>
                                        <td>
